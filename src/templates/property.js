...
export default class PropertyPage extends React.Component {
  ...
  handleSubmit = e => {
    ...
    const form = e.target
    this.setState(
      { address: form.elements["address"].value, submitted: true },
      () => {
        fetch("/", {
          method: "POST",
  ...
  render() {
    ...
    return (
      <Layout>
        <Helmet
          title={
            data.contentfulProperties.address +
            " | " +
          ...
          meta={[
            {
              name: "description",
              content: data.contentfulProperties.fields.seoDescription,
            },
        ...
        <div className="container house">
              ...
              return (
                <article className="message">
                  <div className="message-body">
                    <strong>Thank you for contacting us!</strong> We will get
              ...
              <div className="card">
                <div className="card-image">
                  <figure className="image is-16by9">
                    <Carousel dragging={true}>
                      {data.contentfulProperties.photos.map(
                        ({ localFile }, index) => (
                          <Img
                            key={localFile.id}
                ...
                <header className="card-header">
                  <div className="price">
                    <span className="card-price">
                      $
                      {Number(
                        Math.round(data.contentfulProperties.price + "e2") +
                          "e-2"
                      ).toLocaleString(undefined, { maximumFractionDigits: 2 })}
                    </span>
                    <span className="is-pulled-right is-uppercase house-status">
                      {data.contentfulProperties.status.name}
                    </span>
                  </div>
                </header>
                <div className="card-content">
                  <div className="columns">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.type.name}
                      </span>
                    </div>
                    <div className="column">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.year}
                      </span>
                    </div>
                  </div>
                  <hr />
                  <div className="columns">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.home_size}
                      </span>
                    </div>
                    <div className="column">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.lot_size}
                      </span>
                    </div>
                  </div>
                  <hr />
                  <div className="columns">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.bedrooms}
                      </span>
                    </div>
                    <div className="column">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.bathrooms}
                      </span>
                    </div>
                  </div>
                  <hr />
                  <div className="columns">
                    ...
                    <div className="column">
                      <span className="item-data">
                        {data.contentfulProperties.garages}
                      </span>
                    </div>
                    <div className="column">
                    ...
                    <div className="column">
                      <span className="item-data">
                        ${data.contentfulProperties.hoa_fees}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="column">
              <div className="card contact-us-card is-uppercase">
                <div className="card-content">
                  ...
                  >
                    <FormField name="form-name" type="hidden" value="contact" />
                    <FormField
                      name="address"
                      type="hidden"
                ...
                <footer className="card-footer">
                  ...
                  >
                    <p>
                      <span className="is-uppercase">Send message</span>
                    </p>
                  </button>
                </footer>
              </div>
          ...
          <div className="columns">
            <div className="column is-two-thirds">
              <div className="card">
                <header className="card-header">
                  <p className="card-header-title">Property Details</p>
                </header>
                <div className="card-content">
